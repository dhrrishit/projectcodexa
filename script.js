...
function decrypt() {
    ...
    try {
        ...
        const decrypted = CryptoJS.AES.decrypt(encrypted, key, { iv: CryptoJS.enc.Hex.parse(salt) });
...
document.getElementById("clearDecryptedText").addEventListener("click", function(){
    document.getElementById("decryptedText").value = "";
})

//Copy URL button
document.getElementById("copyURL").addEventListener("click", function(){
       const url = document.getElementById("encryptedURL");
       url.select();
